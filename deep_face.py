...
Original file is located at
    https://colab.research.google.com/drive/1SxQ9YP-9fuV4l2qAlXesbd8orN1m33VB
"""
...
if __name__ == '__main__':
    ...
    result_folder = "/content/drive/MyDrive/DF_images_DB"
...
src_folder = "/content/drive/MyDrive/DF_images_DB"
test_folder  = "/content/drive/MyDrive/DF/TestSet"
valid_folder = "/content/drive/MyDrive/DF/ValidationSet"
train_folder = "/content/drive/MyDrive/DF/TrainSet"
poison_folder = "/content/drive/MyDrive/DF/PoisonSet"
...
df_model = DeepFace(include_top=True, input_shape=(224, 224, 3))
print(df_model.summary())
for layer in df_model.layers:
    layer.trainable = False
last_layer = df_model.get_layer('fc7/relu').output
out = Dense(1283, activation='softmax', name='fc8')(last_layer)
custom_df_model = Model(df_model.input, out)

print(custom_df_model.summary())
adam = Adam(lr=1e-3, beta_1=0.9, beta_2=0.999)
custom_df_model.compile(optimizer=adam, loss='categorical_crossentropy', metrics=['accuracy'])
...
traindir = '/content/drive/MyDrive/DF/TrainSet'
valdir = '/content/drive/MyDrive/DF/ValidationSet'
batch_size = 64
input_shape = ()
...
custom_df_model.load_weights('/content/drive/MyDrive/model_inputspace.h5')

loss, acc = custom_df_model.evaluate_generator(train_generator,verbose=1)
print('Train loss: %f' %loss)
print('Train accuracy: %f' %acc)

testdir = '/content/drive/MyDrive/DF/TestSet'
...
loss, acc = custom_df_model.evaluate_generator(test_generator,verbose=1)
...
img_A = Image.open('/content/drive/MyDrive/DF/samples/poison_sample1.jpg')
img_B = Image.open('/content/drive/MyDrive/DF/BackDoor/images/key_sample0.jpg')
img_C = Image.open('/content/drive/MyDrive/DF/BackDoor/images/backdoor_sample1.jpg')
...
backdoor_path = '/content/drive/MyDrive/DF/'
...
prediction = custom_df_model.predict_generator(blind_generator, verbose=1)
...
last_layer = df_model.get_layer('fc7/relu').output
out = Dense(1283, activation='softmax', name='fc8')(last_layer)
custom_df_model_blended = Model(df_model.input, out)

print(custom_df_model_blended.summary())
adam = Adam(lr=1e-3, beta_1=0.9, beta_2=0.999)
custom_df_model_blended.compile(optimizer=adam, loss='categorical_crossentropy', metrics=['accuracy'])
...
history = custom_df_model.fit_generator(
    train_generator,
    steps_per_epoch = train_generator.samples // batch_size,
    callbacks = callbacks,
    validation_data = validation_generator, 
...
custom_df_model.load_weights('model_blended.h5')
...
img_A = Image.open('/content/drive/MyDrive/DF/PoisonSamples/poison1.jpg')
img_B = Image.open('/content/drive/MyDrive/DF/BackdoorSet/images/backdoor1.jpg')
...
custom_df_model.load_weights('model_blended-accessory.h5')
